...
puts " le nombre de handle dans cette array : #{list.length()}\n\n"
# il doit afficher nombre journaliste    // on peut utiliser .length .count 

puts " Combien y a-t-il de handle dans cette array ?" 
puts list.min { |a,b| a.length <=> b.length }
...
while x != length 
    ...
    puts " il y a #{z} hadles de #{y-1} caractère(s) "
